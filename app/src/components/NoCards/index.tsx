...
export function NoCards() {
    return (
        <Link to="/edit-barbecue" className="flex items-center justify-center h-[200px] w-full bg-custom-gray-500 hover:bg-custom-gray-400 hover:cursor-pointer col-span-4 rounded-md ring-1 ring-custom-gray-400 select-none">
