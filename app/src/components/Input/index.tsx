...
export const Input: React.ForwardRefRenderFunction<HTMLInputElement, InputProps> = ({ text, ...rest }, ref) => {
  return (
    <>
      ...
      <input className="font-Inter bg-custom-gray-500 text-custom-gray-300 p-3 rounded-md font-small text-sm outline-none w-full border border-custom-gray-700 ring-custom-gray-400 focus-within:ring-2" 
